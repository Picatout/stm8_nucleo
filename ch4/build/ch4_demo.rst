...
Hexadecimal [24-Bits]
                                     ...
                                     19 
                                     20 ;--------------------------------------------------------
                                     21 ;some constants used by this program.
                                     22 ;--------------------------------------------------------
                           000100    23 		STACK_SIZE = 256 ; call stack size
                           001700    24 		STACK_BASE = RAM_SIZE-STACK_SIZE ; lowest address of stack
                           0017FF    25 		STACK_TOP = RAM_SIZE-1 ; stack top at end of ram
                                     26 
                                     27 ;--------------------------------------------------------
                                     28 ;   data segment 
                                     29 ;--------------------------------------------------------
                                     ...
                                     36 ;--------------------------------------------------------
                                     37        .area SSEG  (ABS)
      001700                         38 	   .org RAM_SIZE-STACK_SIZE
      001700                         39  __stack_bottom:
      001700                         40 	   .ds  STACK_SIZE 
                                     41 
                                     42 
                                     43 
                                     44 ;--------------------------------------------------------
...
Hexadecimal [24-Bits]
      ...
      008002                         55 init0:
                                     56 
      008002 B6 12            [ 1]   57     ld a,0x12
      008004 CE 34 56         [ 2]   58     ldw x,0x3456
      008007 CD 80 D0         [ 4]   59     call neg24
                                     60 
                                     61     
                                     62 
...
Symbol Table
    ...
    CPU_YL  =  007F07     |     DEBUG_BA=  007F00     |     DEBUG_EN=  007FFF 
...
Symbol Table
    ...
    SPI_TXCR=  005207     |     STACK_BA=  001700     |     STACK_SI=  000100 
    STACK_TO=  0017FF     |     SWIM_CSR=  007F80     |     TIM1_ARR=  005262 
...
Symbol Table
    ...
    WWDG_WR =  0050D2     |   3 __stack_   001700 R   |   5 init0      000000 R
    neg24      ****** GX
...
Area Table
   ...
   4 HOME       size      2   flags    0
   5 CODE       size      8   flags    0
